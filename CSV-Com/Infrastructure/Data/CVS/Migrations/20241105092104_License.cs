        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LicenseHolderId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Licenses_Users_LicenseHolderId",
                        column: x => x.LicenseHolderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Licenses_LicenseHolderId",
                table: "Licenses",
                column: "LicenseHolderId");

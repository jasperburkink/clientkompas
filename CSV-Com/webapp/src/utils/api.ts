...
export const searchUsers = async (searchTerm: string): Promise<sdsdsad[]> => {
    return (await fetchAPI<ClientQuery[]>(`${apiUrl}User/SearchUsers?SearchTerm=${searchTerm}`)).ReturnObject!;
}

...
{
    public class UpdateCoachingProgramCommandValidatorTests
    {
        private readonly UpdateCoachingProgramCommandValidator _validator;
        ...
        public UpdateCoachingProgramCommandValidatorTests()
        {
            _unitOfWorkMock = new Mock<IUnitOfWork>();
            _unitOfWorkMock.Setup(uw => uw.CoachingProgramRepository.ExistsAsync(
            ...
            _validator = new UpdateCoachingProgramCommandValidator(_unitOfWorkMock.Object, _resourceMessageProviderMock.Object);
        ...
        [Fact]
        public async Task Validate_CoachingProgramDoesNotExists_ShouldHaveValidationError()
        {
            // Arrange
            _unitOfWorkMock.Setup(uw => uw.CoachingProgramRepository.ExistsAsync(
               It.IsAny<Expression<Func<CoachingProgram, bool>>>(),

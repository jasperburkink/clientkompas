...
{
    public class GetClientEditEmergencyPersonDtoTests
    {
        ...
        public GetClientEditEmergencyPersonDtoTests()
        {
            _unitOfWorkMock = new();
        ...
        public async Task Handle_GetClient_ShouldReturnEmergencyPersonDto()
        {
            ...
            var emergencyPeople = _client.EmergencyPeople.Select(ep => new GetClientEditEmergencyPersonDto
            {
                Name = ep.Name,

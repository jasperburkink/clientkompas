...
{
    public class GetClientEditMaritalStatusDtoTests
    {
        ...
        public GetClientEditMaritalStatusDtoTests()
        {
            _unitOfWorkMock = new();
        ...
        [Fact]
        public async Task Handle_GetClient_ShouldReturnMaritalStatusDto()
        {
            // Arrange
            var query = new GetClientEditQuery { ClientId = _client.Id };

            var maritalStatus = new GetClientEditMaritalStatusDto
            {
                Name = _client.MaritalStatus.Name,
                Id = _client.MaritalStatus.Id
            };
            ...
            // Assert
            result.MaritalStatus.Should().NotBeNull().And.BeEquivalentTo(maritalStatus);
        }
    }
}

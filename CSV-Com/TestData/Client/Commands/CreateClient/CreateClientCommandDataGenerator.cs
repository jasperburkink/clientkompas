...
namespace TestData.Client.Commands.CreateClient
{
    public class CreateClientCommandDataGenerator : ITestDataGenerator<CreateClientCommand>
    {
        ...
        private Faker<CreateClientCommand> GetFaker()
        {
            ...
            return new AutoFaker<CreateClientCommand>()
                .StrictMode(true)

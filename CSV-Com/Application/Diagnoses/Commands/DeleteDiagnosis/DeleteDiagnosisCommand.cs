...
{
    public record DeleteDiagnosisCommand : IRequest<int>
        {
            public int Id { get; init; }
        }

        public class DeleteDiagnosisCommandHandler : IRequestHandler<DeleteDiagnosisCommand, int>
        {
            ...
            public async Task<int> Handle(DeleteDiagnosisCommand request, CancellationToken cancellationToken)
            {

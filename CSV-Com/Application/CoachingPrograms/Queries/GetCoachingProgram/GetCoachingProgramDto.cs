...
{
    public class GetCoachingProgramDto : IMapFrom<Domain.CVS.Domain.CoachingProgram>
    {
        ...
        {
            profile.CreateMap<Domain.CVS.Domain.CoachingProgram, GetCoachingProgramDto>()

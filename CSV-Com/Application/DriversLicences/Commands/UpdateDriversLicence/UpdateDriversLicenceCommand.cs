...
{
    public record UpdateDriversLicenceCommand : IRequest<int>
    {
    ...
    public class UpdateDriversLicenceCommandHandler : IRequestHandler<UpdateDriversLicenceCommand, int>
    {
        ...
        public async Task<int> Handle(UpdateDriversLicenceCommand request, CancellationToken cancellationToken)
        {
